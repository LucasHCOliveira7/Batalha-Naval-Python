...
JOGADOR1 = open('./Regras/ep1check_windows/ct1/jogador1.txt', 'r')      # abre e lê o arquivo jogador1.txt
JOGADOR2 = open('./Regras/ep1check_windows/ct1/jogador2.txt', 'r')      # abre e lê o arquivo jogador2.txt
RESULTADO = open('./Regras/ep1check_windows/ct1/resultado.txt', 'w')    # abre e escreve no arquivo resultado.txt
...
def main():
    ...
    for contagem1 in range(0,len(TODAS_POSICOES_JG1)):
        if TODAS_POSICOES_JG1.count(TODAS_POSICOES_JG1[contagem1]) > 1:
            RESULTADO.write('JOGADOR1 ERROR_OVERWRITE_PIECES_VALIDATION')
            return
        
    for contagem2 in range(0,len(TODAS_POSICOES_JG2)):
        if TODAS_POSICOES_JG2.count(TODAS_POSICOES_JG2[contagem2]) > 1:
            RESULTADO.write('JOGADOR2 ERROR_OVERWRITE_PIECES_VALIDATION')
            return
